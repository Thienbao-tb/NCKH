...
<div class="alert alert-warning" role="alert">
    ...
    <p><strong style="color: red;">"PT123 - 104768 - 0942274558"</strong></p>
    <p>Trong đó 104768 là mã thành viên, 0942274558 là số điện thoại của bạn đăng ký trên website phongtrodanang.com.
    </p>
    <p>Xin cảm ơn!</p>
</div>
<table class="table table-bordered table-striped">
    <tbody>
        ...
        <tr>
            ...
            <td style="white-space: nowrap;">VÕ THÀNH TIẾN</td>
            <td style="white-space: nowrap;">0041000379015<br><button class="btn btn-secondary btn-copy js-btn-copy"
            ...
            <td rowspan="6" style="white-space: nowrap; color: red;">Nội dung chuyển khoản, bạn ghi rõ:<br>
                <strong>"PT123 - 104768 - 0942274558"</strong><br><button class="btn btn-secondary btn-copy js-btn-copy"
                    title="Sao chép liên kết" data-clipboard-text="PT123 - 104768 - 0942274558"><span
        ...
        <tr>
            ...
            <td style="white-space: nowrap;">VÕ THÀNH TIẾN</td>
            <td style="white-space: nowrap;">31010001745233<br><button class="btn btn-secondary btn-copy js-btn-copy"
